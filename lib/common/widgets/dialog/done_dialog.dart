...
class _DoneDialogState extends State<DoneDialog> {
  ...
  Future<void> _closeDialog() async {
    await Future.delayed(const Duration(milliseconds: 1500)); // Задержка 5 секунд
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(widget.title, style: GoogleFonts.montserrat(fontSize: 20, fontWeight: FontWeight.w500,)),
            ],
          ),
        ),
      )
